...
export default function Hero() {
  return (
    <section className="relative min-h-[75vh] pt-20">
      {/* Background blur */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-stretch gap-8 px-6 lg:px-8 py-12">
        {/* Left */}
